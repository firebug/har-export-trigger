...
// Firebug.SDK
const { DebuggerServer, DebuggerClient, devtools, safeRequire } = require("firebug.sdk/lib/core/devtools.js");
const { Trace, TraceError } = require("firebug.sdk/lib/core/trace.js").get(module.id);
const { TriggerToolboxOverlay } = require("./trigger-toolbox-overlay.js");

// Platform
const { HarAutomation } = safeRequire(devtools,
  "devtools/client/netmonitor/har/har-automation",
  "devtools/netmonitor/har/har-automation"
);
